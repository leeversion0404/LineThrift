...
const PRIMARY_DEVICE = "IOS\t14.5.0\tiOS\t14.4.2"
const SECONDARY_DEVICE = "IOSIPAD\t14.5.0\tiOS\t14.4.2"
const THIRD_DEVICE = "ANDROIDLITE\t2.17.1\tAndroid OS\t1"
const ANDROID_DEVICE = "ANDROID\t11.5.0\tAndroid OS\t9.0.0"

const SYSTEM_NAME = "LeeVersion-PC"
const LINE_LIFF_ID = "1602687308-GXq4Vvk9"
